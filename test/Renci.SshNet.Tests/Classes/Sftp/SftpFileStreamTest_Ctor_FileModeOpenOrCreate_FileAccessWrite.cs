    ...
    public class SftpFileStreamTest_Ctor_FileModeOpenOrCreate_FileAccessWrite : SftpFileStreamTestBase
    {
        ...
        protected override void SetupMocks()
        {
            SftpSessionMock.InSequence(MockSequence)
                           .Setup(p => p.RequestOpen(_path, Flags.Write | Flags.CreateNewOrOpen, false, null))
                           .Returns(_handle);
            SftpSessionMock.InSequence(MockSequence)
        ...
        {
            SftpSessionMock.Verify(p => p.RequestOpen(_path, Flags.Write | Flags.CreateNewOrOpen, false, null), Times.Once);
        }
    }
}
