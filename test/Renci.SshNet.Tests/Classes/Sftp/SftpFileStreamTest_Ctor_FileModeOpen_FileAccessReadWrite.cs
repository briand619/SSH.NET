    ...
    public class SftpFileStreamTest_Ctor_FileModeOpen_FileAccessReadWrite : SftpFileStreamTestBase
    {
        ...
        protected override void SetupMocks()
        {
            SftpSessionMock.InSequence(MockSequence)
                           .Setup(p => p.RequestOpen(_path, Flags.Read | Flags.Write, false, null))
                           .Returns(_handle);
            SftpSessionMock.InSequence(MockSequence)
        ...
        {
            SftpSessionMock.Verify(p => p.RequestOpen(_path, Flags.Read | Flags.Write, false, null), Times.Once);
        }
    }
}
