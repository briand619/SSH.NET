    ...
    public class SftpFileStreamTest_Ctor_FileModeTruncate_FileAccessWrite : SftpFileStreamTestBase
    {
        ...
        protected override void SetupMocks()
        {
            SftpSessionMock.InSequence(MockSequence)
                           .Setup(p => p.RequestOpen(_path, Flags.Write | Flags.Truncate, false, null))
                           .Returns(_handle);
            SftpSessionMock.InSequence(MockSequence)
        ...
        {
            SftpSessionMock.Verify(p => p.RequestOpen(_path, Flags.Write | Flags.Truncate, false, null), Times.Once);
        }
    }
}
